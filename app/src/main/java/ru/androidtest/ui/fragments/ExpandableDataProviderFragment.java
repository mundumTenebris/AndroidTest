...
import ru.androidtest.dataProviders.ExpandableDataProvider;
...
public class ExpandableDataProviderFragment extends Fragment {
    ...
    public static ExpandableDataProviderFragment newInstance() {
        return new ExpandableDataProviderFragment();
    }
